  ...
  return (
    <div className="min-h-screen bg-yellow-300">
      ...
      <div className="container mx-auto px-0 sm:px-4 py-8 max-w-screen-sm">
        <header className="flex items-center justify-between mb-16 px-4 sm:px-0">
          <div className="text-2xl font-bold text-teal-600">
            <span className="text-white">DAYSYNC</span>
          </div>
          {/* <div className="text-white text-xl">09:30</div> */}
        </header>
        ...
        <div className="mt-8 px-4 sm:px-0">
          <button className="w-full bg-teal-600 text-white py-4 rounded-full text-lg font-semibold">
            Make an appointment
          </button>
        </div>
      </div>
